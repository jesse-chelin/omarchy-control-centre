...
EXPECTED = {
    ...
    0xF0901: 'md-sleep, hibernate (the stock menu Hibernate glyph)',
    0xF0343: 'md-exit_run, log out (the stock menu Logout glyph)',
    0xF0709: 'md-restart, restart (the stock menu Reboot glyph)',
    0xF0425: 'md-power, shut down (the stock menu Shutdown glyph)',
    0xF030: 'fa-camera, screenshot (the stock menu Screenshot glyph)',
    0xF118: 'fa-smile_o, emoji (the stock menu Emoji glyph)',
    0xF07F: 'fa-clipboard, clipboard (the stock menu Clipboard glyph)',
    0xF00C9: 'md-eyedropper, colour picker (the stock menu Color glyph)',
    0xF0D11: 'md-text_recognition, grab text (the stock menu Text glyph)',
    0xF0432: 'md-qrcode_scan, scan QR (the stock menu QR glyph)',
    0xF088C: 'md-reminder (the stock menu Reminder glyph, also the bar indicator)',
    0xF50E: 'fa-share_alt, share (the stock menu Share glyph)',
    0xF09F8: 'md-movie_edit, transcode (the stock menu Transcode glyph)',
    0xF07F8: 'md-touchpad (the stock menu Touchpad glyph)',
    0xF01BD: 'md-gesture_tap, touchscreen (the stock menu Touchscreen glyph)',
    0xF06E7: 'md-laptop_off, laptop display (the stock menu Laptop Display glyph)',
    0xF0379: 'md-monitor, mirror display (the stock menu Mirror glyph)',
    0xEC19: 'cod-server_process, hybrid GPU (the stock menu Hybrid GPU glyph)',
    0xF035C: 'md-menu, the menu bar (the stock menu Menu Bar glyph)',
    0xE62A: 'seti-config, window gaps (the stock menu Window Gaps glyph)',
    0xF10AC: 'md-view_split_vertical, workspace layout (the stock menu glyph)',
    0xF2D0: 'fa-window_maximize, square ratio (the stock menu 1-Window Ratio glyph)',
    0xF16A1: 'md-bug_stop, crash capture (the stock menu Crash Capture glyph)',
    0xF02CA: 'md-harddisk, disk speed (the stock menu Disk Speed Test glyph)',
    0xEBCF: 'cod-symbol_color, theme (the stock menu Style glyph)',
